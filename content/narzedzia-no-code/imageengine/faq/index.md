...
hero:
  ...
  subheading: Jak działa device detection, jak wyglądają limity, SLA i integracja
    z Twoim obecnym CDN-em.
  image:
    src: /img/article_image.jpeg
    alt: Abstrakcyjna wizualizacja danych i dashboardów na tle jeziora
seo:
  title: 'ImageEngine – FAQ dla osób myślących o migracji obrazów'
  description: 'Zbieram kluczowe pytania o ImageEngine: techniczne wymagania, wsparcie,
