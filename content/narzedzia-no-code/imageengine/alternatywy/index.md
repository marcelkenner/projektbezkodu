...
hero:
  ...
  subheading: Porównuję ImageEngine z innymi image-CDN-ami pod kątem ceny, jakości
...
seo:
  ...
  description: Zestawiam ImageEngine z innymi usługami optymalizacji obrazów, żeby
    łatwiej było dobrać narzędzie pod Twój stack.
---
