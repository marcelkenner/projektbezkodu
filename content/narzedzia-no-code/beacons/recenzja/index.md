...
- oficjalnym cenniku i listach funkcji na stronie [Beacons](https://beacons.ai),
...
- **Link in bio / mikrostrona** – mobilna strona z linkami, sekcjami, wideo, formularzami. Oficjalnie Beacons promuje ją jako „free, customizable Link in Bio” z mediakit i sklepem nawet na darmowym planie [cennik Beacons](https://beacons.ai/i/plans).
...
Polski artykuł o Beacons dobrze to podsumowuje: to platforma „all-in-one” łącząca link in bio, sklep, e-mail marketing, kalendarz rezerwacji i analitykę w jednym miejscu, mocno oparta o automatyzację i AI [opis Beacons po polsku](https://codelivery.eu/blog/beacons-ai-co-to-jest/).
...
- na darmowym planie masz nie tylko link in bio i media kit, ale też możliwość sprzedawania nielimitowanej liczby produktów cyfrowych oraz podstawowy e-mail marketing – według oficjalnego cennika dostajesz m.in. 50 wysyłek e-maili miesięcznie i aktualizujący się co tydzień media kit [cennik Beacons](https://beacons.ai/i/plans),
...
Użytkownicy chwalą też niski próg wejścia i stosunek możliwości do ceny. W recenzjach na Trustpilot powtarza się motyw, że panel jest „easy to use, build, create and navigate” i daje „a lot of value for price” w porównaniu z innymi platformami dla twórców [recenzje na Trustpilot](https://www.trustpilot.com/review/beacons.ai).
...
- dopiero plan z 0% seller fees (kiedyś „Store Pro”, obecnie Creator Plus / Store Pro) zdejmuje prowizje, ale kosztuje ok. 25–30 USD miesięcznie przy rozliczeniu rocznym, w zamian odblokowując 0% opłat od sprzedaży, nielimitowane e-maile i sprzedaż kursów/membershipów [Oficjalny cennik](https://beacons.ai/i/plans), [analiza cen i opłat](https://fritz.ai/what-is-beacons-ai-review/), [inne recenzje cen](https://www.theleap.co/blog/beacons-pricing/).
...
To nie jest „ukryty koszt” – Beacons komunikuje te procenty w cenniku – ale wielu twórców realnie zaczyna się irytować dopiero wtedy, gdy widzi swoje raporty sprzedaży. W recenzjach twórców pojawia się dokładnie ten wątek: platforma jest świetna, dopóki sprzedaż jest mała; przy większej skali 9% i jakość supportu stają się „buzzkillami” [przykładowa recenzja twórcy](https://freerdps.com/blog/beacons-ai-review/), [szczegółowa analiza opłat](https://skywork.ai/skypage/en/Beacons-AI-Review-2025-Is-This-The-Ultimate-Beacon-for-Creator-Success/1973913389733310464).
...
- na płatnych planach dodasz własną domenę i ukryjesz brand Beacons [cennik i funkcje](https://beacons.ai/i/plans).
...
- na planach z 0% prowizji dostajesz nielimitowaną sprzedaż bez opłaty od transakcji, wsparcie dla kursów i członkostw oraz dodatkowe opcje jak buy now, pay later [strona sklepu Beacons](https://beacons.ai/i/store-app-landing-page-2-0),
...
- na darmowym planie masz mały limit wysyłek (50 maili/miesiąc), który rośnie na wyższych planach – na planie z 0% prowizji masz nielimitowany e-mail [porównanie planów](https://beacons.ai/i/plans),
...
- Beacons ma moduł media kit, który automatycznie zaciąga statystyki z twoich profili i aktualizuje je co tydzień lub codziennie, w zależności od planu [porównanie planów](https://beacons.ai/i/plans),
- oferuje kalkulator stawek za współprace, generator W-9 (dla rynku USA), proste fakturowanie i panel do obsługi współprac [opis funkcji dla twórców](https://beacons.ai/i/creator-university/guide/your-ultimate-guide-to-building-a-creator-business-with-beacons),
...
- na każdym planie dostajesz pulę „AI credits”, które wykorzystujesz na generowanie tekstów, grafik, layoutów i maili, oraz analizę trendów contentu, z limitami zależnymi od planu [opis kredytów AI](https://beacons.ai/i/plans),
...
- prostota użycia i to, że „app is completely free and easy to use” przy konfiguracji bio linku i sklepu [opinie w App Store](https://apps.apple.com/us/app/6444589346?platform=iphone&see-all=reviews),
- stosunek funkcji do ceny – użytkownicy piszą, że panel jest „easy to use, build, create and navigate” i że model cenowy daje dużo wartości jak na platformę dla twórców [Trustpilot](https://www.trustpilot.com/review/beacons.ai),
- możliwość centralizacji wszystkiego: linków, sklepu, media kitu i e-mail w jednym miejscu [strona główna Beacons](https://beacons.ai), [blog Beacons o narzędziach dla twórców](https://beacons.ai/i/creator-university/guide/your-ultimate-guide-to-building-a-creator-business-with-beacons).

Najczęstsze skargi:

- wspomniane wcześniej **9% opłat od sprzedaży** na darmowym i tańszym planie, które przy rosnącej sprzedaży realnie zjadają zyski – to główny punkt krytyki w niezależnych recenzjach [szczegółowa recenzja z krytyką opłat](https://autoposting.ai/beacons-ai-review/), [omówienie planów i fees](https://skywork.ai/skypage/en/Beacons-AI-Review-2025-Is-This-The-Ultimate-Beacon-for-Creator-Success/1973913389733310464),
...
- okazjonalne bugi w mniej popularnych funkcjach (np. media kit w aplikacji mobilnej) [wybrane recenzje w App Store](https://apps.apple.com/us/app/6444589346?platform=iphone&see-all=reviews).
...
W osobnym materiale porównujemy [alternatywy dla Beacons](/narzedzia/beacons/alternatywy/). Dla recenzji wystarczy szybkie ustawienie w kadrze:
...
- szczegółowy [cennik Beacons i progi opłacalności](/narzedzia/beacons/cennik/),
- najlepsze [alternatywy dla Beacons](/narzedzia/beacons/alternatywy/),
- jak ustawić [SEO w Beacons](/narzedzia/beacons/seo/) i traktować go jak prosty CMS,
- jak wykorzystać Beacons do [marketingu afiliacyjnego](/narzedzia/beacons/marketing-afiliacyjny/) oraz [e-commerce w polskich realiach](/narzedzia/beacons/ecommerce-pl/),
- konkretne [przykłady stron i szablonów](/narzedzia/beacons/przyklady/), które możesz skopiować.
