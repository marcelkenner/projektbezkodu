...
Przykład to krótka demonstracja działania koncepcji — może to być zdanie, fragment kodu, zrzut ekranu lub krok po kroku. Jasny przykład pokazuje, jak teoria wygląda w praktyce; nieczytelny przykład zamiast tego tworzy dodatkowe pytania. Definicje i zasady formatowania przykładów znajdziesz też w zasobach edytorskich, np. w poradnikach Wikisłownika. ([[pl.wiktionary.org](https://pl.wiktionary](https://pl.wiktionary.org/wiki/Wikis%C5%82ownik%3AZasady_tworzenia_hase%C5%82?utm_source=openai).org/wiki/Wikis%C5%82ownik%3AZasady_tworzenia_hase%C5%82?utm_source=openai))

W praktyce: jeśli opisujesz funkcję, pokaż ją na jedną-dwie linijki kodu plus oczekiwany wynik.

## Jak zacząć (plan na 5 minut)
1. Zidentyfikuj jeden kluczowy efekt, który chcesz pokazać.  
2. Przygotuj minimalne wejście (najmniejszy możliwy przykład działający).  
3. Dodaj krótki komentarz 1–2 zdania: co robi ten przykład i jaki daje rezultat.  
4. (Opcjonalnie) dodaj link do źródła lub dokumentacji — np. [polska Wikipedia](https://pl.wikipedia.org/). ([[en.wikipedia.org](https://en.wikipedia](https://en.wikipedia.org/wiki/Polish_Wikipedia?utm_source=openai).org/wiki/Polish_Wikipedia?utm_source=openai))
...
Werdykt: podaj datę/wersję i link do źródła; w tekstach publicznych lepiej linkować do stabilnych zasobów (np. dokumentacji projektów lub encyklopedii). ([[en.wikipedia.org](https://en.wikipedia](https://en.wikipedia.org/wiki/Polish_Wikipedia?utm_source=openai).org/wiki/Polish_Wikipedia?utm_source=openai))
...
- W dokumentacji technicznej dodaj wersję narzędzi/komponentów. _W przeciwnym razie_ czytelnik może otrzymać inne rezultaty.  
- Jeśli potrzebujesz wzorca do formatowania przykładów, szukaj w przewodnikach edytorskich i repozytoriach przykładów (linki i zasoby warto odnotować bezpośrednio przy przykładzie). ([[pl.wiktionary.org](https://pl.wiktionary](https://pl.wiktionary.org/wiki/Wikis%C5%82ownik%3AZasady_tworzenia_hase%C5%82?utm_source=openai).org/wiki/Wikis%C5%82ownik%3AZasady_tworzenia_hase%C5%82?utm_source=openai))
