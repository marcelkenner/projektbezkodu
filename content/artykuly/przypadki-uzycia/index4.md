...
1. Wybierz formularz (Typeform, Google Forms lub wbudowany w CRM).  
2. Podłącz formularz do arkusza/CRM przez natywne połączenie lub Zapier/Make.  
3. Dodaj 3–5 pól, które od razu dają kontekst (branża, rola, potrzeba).  
4. Ustal proste reguły punktacji (np. demo = +30, odwiedził pricing = +10).  
5. Stwórz jedno automatyczne powiadomienie lub mail dla wysokiego scoringu.

### Formularze: co ustawić pierwsze
- Pytania, które _naprawdę_ zmieniają decyzję sprzedaży.  
- CAPTCHA/honeypot, żeby filtrować spam.  
- Jasna informacja o prywatności przy polu e-mail.  
Dobre praktyki przy formularzach znajdziesz w praktycznym przewodniku dotyczącym tworzenia formularzy. ([[insidea.com](https://insidea.com/blog](https://insidea.com/blog/hubspot/lead-capture-form/?utm_source=openai)/hubspot/lead-capture-form/?utm_source=openai))
...
Werdykt: **zaczynasz od prostych punktów i testujesz**, dokumentacja i przykłady scoringu pomagają ustawić reguły. ([[blog.hubspot.com](https://blog.hubspot](https://blog.hubspot.com/marketing/lead-scoring-instructions?utm_source=openai).com/marketing/lead-scoring-instructions?utm_source=openai))
...
Źródła: przewodnik o lead scoringu oraz dokumentacja narzędzi do scoringu i formularzy pomagają wdrożyć ten proces krok po kroku. [Przewodnik HubSpot o lead scoringu](https://blog.hubspot.com/marketing/lead-scoring-instructions). ([[blog.hubspot.com](https://blog.hubspot](https://blog.hubspot.com/marketing/lead-scoring-instructions?utm_source=openai).com/marketing/lead-scoring-instructions?utm_source=openai))
