...
5. Zorganizuj dane: nadaj wywiadom zmienne pomocnicze (data, grupa, identyfikator), żeby móc je łączyć z wynikami ankiety. To prosty krok, który ułatwia późniejszą analizę. ([[guides.nyu.edu](https://guides.nyu](https://guides.nyu.edu/QDA/mixedmethods?utm_source=openai).edu/QDA/mixedmethods?utm_source=openai))

Jeśli nie masz pewności, jak nazwać wzorzec integracji, sprawdź [SAGE] — tam jest zbiór opisów i przykładów projektów. ([[us.sagepub.com](https://us.sagepub](https://us.sagepub.com/en-us/nam/mixed-methods/book228130?utm_source=openai).com/en-us/nam/mixed-methods/book228130?utm_source=openai))
...
W praktyce nie musisz używać drogich systemów — wystarczy arkusz + prosty system katalogowania nagrań i transkryptów. Jeśli planujesz poważniejsze analizy, narzędzia typu MAXQDA, NVivo czy Atlas.ti pomagają mapować fragmenty wywiadów na zmienne i kody; porady dotyczące organizacji danych znajdziesz też w poradnikach uniwersyteckich. _Uwaga: wybór narzędzia zależy od skali i budżetu._ ([[guides.nyu.edu](https://guides.nyu](https://guides.nyu.edu/QDA/mixedmethods?utm_source=openai).edu/QDA/mixedmethods?utm_source=openai))
...
Zrób to w 30–60 minut: zapisz 2 pytania badawcze → wybierz wzorzec integracji (np. explanatory sequential) → przygotuj 8–12 pytań ankietowych + 4–6 zaproszeń do wywiadów pilotażowych (krótkie nagrody). Jeśli chcesz pogłębić teorię i przykłady wzorców, przeczytaj krótki przewodnik [SAGE]. ([[us.sagepub.com](https://us.sagepub](https://us.sagepub.com/en-us/nam/mixed-methods/book228130?utm_source=openai).com/en-us/nam/mixed-methods/book228130?utm_source=openai))

## Źródła i dalsze czytanie
- SAGE — przegląd podejść mixed methods i projekty przykładów. ([[us.sagepub.com](https://us.sagepub](https://us.sagepub.com/en-us/nam/mixed-methods/book228130?utm_source=openai).com/en-us/nam/mixed-methods/book228130?utm_source=openai))  
- Poradnik organizacji analiz mixed methods (uniwersytet/guide). ([[guides.nyu.edu](https://guides.nyu](https://guides.nyu.edu/QDA/mixedmethods?utm_source=openai).edu/QDA/mixedmethods?utm_source=openai))
