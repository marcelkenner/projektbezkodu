...
- Documentation should be concise, actionable, and under 200 lines per file. Use headings + checklists where helpful.
- Cross-link related docs (e.g., reference plans from the index) and update the relevant plan when new work is documented.
