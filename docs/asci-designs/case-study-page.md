┌────────────────────────────────────────────────────────────────────────────┐
│ BREADCRUMBS: Home › Case studies › [Klient/Projekt] │
│ H1: "[Klient] — [Efekt w liczbach]" │
│ META: branża • okres • stack │
│ HERO: IMG (wynik/ekran) alt kontekstowy width/height sizes/srcset │
│ SEKCJE: │
│ • Streszczenie (3–5 bulletów z metrykami: +X% ruchu, −Y% time‑to‑ship…) │
│ • Problem → Rozwiązanie → Rezultat (H2, H2, H2) │
