...
│ RSS autora: link "Subskrybuj artykuły autora" (type="application/rss+xml") │
└────────────────────────────────────────────────────────────────────────────┘
SEO: Author Page z `Person` (JSON-LD: name, sameAs, image).
A11y: <nav aria-label="Artykuły autora"> dla listy.
