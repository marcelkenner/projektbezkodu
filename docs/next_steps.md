...
5. Extend taxonomy coverage to tutorials/comparisons so future filters share a unified catalog (capture mapping updates in `docs/brand/frontmatter_schema.md` when ready).
