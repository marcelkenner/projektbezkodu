...
export function NewsletterSection({ copy }: { copy: NewsletterCopy }) {
  ...
  return (
    <section className="homepage-section homepage-section--newsletter" aria-labelledby="newsletter-heading">
      <div className="pbk-container homepage-newsletter__wrapper">
        <div className="homepage-newsletter__content">
          ...
          <p>{copy.body}</p>
          <form className="homepage-newsletter__form" action="/api/newsletter/subscribe" method="post">
            ...
            <label className="homepage-newsletter__consent">
              <input type="checkbox" name="consent" required /> {form.consentLabel}
            </label>
